...
// ProduceMessage provides a mock function with given fields: topic, protoMessage
func (_m *Producer) ProduceMessage(topic string, protoMessage protoreflect.ProtoMessage) error {
